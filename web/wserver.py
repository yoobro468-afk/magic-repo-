...
rawowners = "<h1 style='text-align: center'><a href='https://t.me/MrSagarBots'>@MrSagarBots</a></h1>"
...
<body>
    <!--© Designed and coded by @MrSagar0-Telegram-->
    <header>
        <div class="brand">
        ...
        <div class="social">
            <a href="https://t.me/MrSagarBots"><i class="fab fa-github"></i></a>
            <a href="https://t.me/MrSagarBots"><i class="fab fa-telegram"></i></a>
        </div>
    </header>
    <!-- pin_entry -->
    <!-- files_list -->
